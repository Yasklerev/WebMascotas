...
urlpatterns = [
    ...
    path('', include("apps.newProducts.addProducts.urls")),
    path('', include("apps.userMenu.profileUser.urls")),
    path('', include("apps.userMenu.shoppingCart.urls")),
    path('', include("apps.products.medicine.urls")),
    path('', include("apps.login.urls")),
    path('', include("apps.user.urls")),
    path('', include("apps.userMenu.paymentHistory.urls")),
    path('', include("apps.userMenu.paymentMethod.urls")),
